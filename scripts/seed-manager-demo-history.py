...
MENU = [
    ("lantern-lager", "lantern-lager:pint", "draft-beer", "Lantern House Lager", 825),
    ("amber-ale", "amber-ale:pint", "draft-beer", "Copper Amber Ale", 875),
    ("hazy-ipa", "hazy-ipa:regular", "craft-beer", "Local Hazy IPA", 925),
    ("irish-stout", "irish-stout:regular", "imported-beer", "Irish Stout", 950),
    ("dry-cider", "dry-cider:regular", "cider-na", "Ontario Dry Cider", 875),
    ("hop-water", "hop-water:regular", "cider-na", "Sparkling Hop Water", 550),
    ("wings", "wings:regular", "appetizers", "Chicken Wings", 1850),
    ("poutine", "poutine:regular", "appetizers", "Classic Poutine", 1450),
    ("pretzel", "pretzel:regular", "appetizers", "Giant Pub Pretzel", 1350),
    ("nachos", "nachos:regular", "appetizers", "Loaded Pub Nachos", 1950),
    ...
    ("fish-chips", "fish-chips:regular", "mains", "Beer-Battered Fish and Chips", 2250),
    ("chicken-pot-pie", "chicken-pot-pie:regular", "mains", "Chicken Pot Pie", 2050),
    ("steak-frites", "steak-frites:regular", "mains", "Steak Frites", 2950),
    ("caesar-salad", "caesar-salad:regular", "salads-vegetarian", "Caesar Salad", 1450),
